...
2. Ler **wrapper** em `.domain/wrappers/` (autoridade de path); skill em `.domain/skills/{nome}/`; **sem `/domain.clarify`**. Fases: Evidências → Estratégico → Descoberta → Operacional (aliases G0–G2).
